...
set_property PACKAGE_PIN U18 [get_ports button_c]
set_property IOSTANDARD LVCMOS33 [get_ports button_c]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_c]

set_property PACKAGE_PIN W19 [get_ports button_l]
set_property IOSTANDARD LVCMOS33 [get_ports button_l]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_l]
